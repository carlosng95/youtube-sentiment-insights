...
def main():
    try:
        ...
        X_train_tfidf, y_train = apply_tfidf(train_data, max_features = max_features, ngram_range = ngram_range)
        
        best_model = train_lgbm(X_train_tfidf, y_train, learning_rate = learning_rate, max_depth = max_depth, n_estimators = n_estimators)
